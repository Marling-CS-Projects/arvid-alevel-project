...
For the game to be accessible to the widest audience possible the inclusion of inappropriate material would have to be limited. As there needed to be a state which represented failing the level, a death or knockout would be the most logical solution following the existence of threats like spikes and sawblades. The game has a health bar and death screen, but no sign of damage to the player when damage is taken, and no blood/gore. Furthermore there is no strong language and there are no sensitive topics covered, so people who may be upset by such things should still be able to enjoy the game. I consider this test a success, as the testers answered as I expected that there was no inappropriate content in this game.

#### Criterion 29:

<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption></figcaption></figure>

Consistent visual style allows for better immersion/focus on the game by allowing the player to recognise elements in the game at a glance, or infer what they are based off of previous encounters. This reduces the time the player spends being confused and figuring parts of the game out, reducing frustration and hence allowing for the player to have more fun. As I had a very simplistic visual style, the clarity was mainly down to colour coding and shape, which was established in question 2 and criterion 4. The testers expectedly all agreed, mostly strongly agreed.
