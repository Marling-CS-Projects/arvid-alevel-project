...
This question may seem redundant compared to the previous question. This is not the case, and while it explains and reinforces the same types of questions, it addresses a different issue. If the UI wasn't visually cluttered but impossible to understand, then there wouldn't be much point to it being simplified, or to be there at all.
