...
The only bug experienced was the player body being able to pass through the flat face of another body horizontally when between the flat face and a circular body, in this case a rotating one. I was not able to reproduce the bug and nothing similar was experienced from other testers when they landed in the same position.
