...
Combat in Rain World is what would usually be expected from a game of it's style. There isn't a combat system beyond picking objects up an throwing them. There is no system specifically implemented to aim, there isn't a clear health system, and the player has no permanent attack or weapon.&#x20;
