...
| Soul              | Having a resource that is gained via hitting enemies is nothing new. The idea to us it for both a defensive and offensive resource with payoffs and consequences however is a fun dynamic that, once again, let the player to play how they feel.                                                           |
{% endtab %}
...
Add a screenshot of the skill tree here please ty
