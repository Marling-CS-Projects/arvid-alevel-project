...
![The White Slugcat called 'The Survivor' riding on another creature to escape a hazardous field of... grass.](<../.gitbook/assets/image (2) (1).png>)
...
![The Knight upgrading a spell, Abyss Shriek](<../.gitbook/assets/image (4).png>)

![A charm shop](<../.gitbook/assets/image (2).png>)
...
Combat isn't one of Ori's strong suites. The combat, for all intents and purposes, is quite shallow. While the auto-aimed main attack is part of the issue. It simplifies combat to the point&#x20;
